...
public class TRegexOptions {
     ...
     * {@link com.oracle.truffle.regex.tregex.parser.RegexASTBuilder}).
     */
    ...
    /**
     * Bailout threshold for number of transitions in the DFA ({@link TRegexDFAExecutorNode}
     * generated by {@link DFAGenerator}).
     */
    public static final int TRegexMaxDFATransitions = 3_000;

    /**
     * Bailout threshold for number of partial capture group transitions in the DFA
     * ({@link TRegexDFAExecutorNode} generated by {@link DFAGenerator}).
     */
    public static final int TRegexMaxDFACGPartialTransitions = 3_000;
     ...
     * than 255, because the maximum number of NFA states in one D