...
public class StepOutResponse extends Response {
    ...
    StepOutResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        StepOutResponse other = (StepOutResponse) obj;
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + Integer.hashCode(this.getRequestSeq());
        hash = 79 * hash + Boolean.hashCode(this.isSuccess());
        hash = 79 * hash + Objects.hashCode(this.getCommand());
        if (this.getMessage() != null) {
            hash = 79 * hash + Objects.hashCode(this.getMessage());
        }
    ...
    public static StepOutResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new StepOutResponse(json);
    }
}