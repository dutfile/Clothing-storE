...
public class DeclarationParams extends TextDocumentPositionParams {
    ...
    DeclarationParams(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public DeclarationParams setWorkDoneToken(Object workDoneToken) {
    ...
    public DeclarationParams setPartialResultToken(Object partialResultToken) {
    ...
    public boolean equals(Object obj) {
        ...
        DeclarationParams other = (DeclarationParams) obj;
    ...
    public static DeclarationParams create(TextDocumentIdentifier textDocument, Position position) {
        final JSONObject json = new JSONObject();
        json.put("textDocument", textDocument.jsonData);
        json.put("position", position.jsonData);
        return new DeclarationParams(json);
    }
}